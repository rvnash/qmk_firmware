...
KC_NO, ASTROIDS, KC_NO, KC_NO, KC_NO, KC_NO, OLED_TOG, OLED_LOGO, KC_NO, OLED_BRIU, KC_BRIU, KC_NO, \
LCTL(KC_LEFT), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BRID, LCTL(KC_RIGHT), \
