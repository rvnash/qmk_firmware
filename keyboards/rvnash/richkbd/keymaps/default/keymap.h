...
KC_NO, KC_LCTL, KC_LALT, KC_LGUI, KC_NO, KC_NO, KC_NO, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_NO, \
KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, KC_RSFT, \
...
LCTL(KC_LEFT), ASTROIDS, KC_NO, KC_NO, KC_NO, KC_NO, OLED_TOG, OLED_LOGO, KC_NO, OLED_BRIU, KC_BRIU, LCTL(KC_RIGHT), \
KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BRID, KC_RSFT, \
...
LCTL(KC_LEFT), KC_F10, KC_F1, KC_F2, KC_F3, KC_PAUS, KC_NO, KC_NO, KC_NO, KC_ALGR, KC_NO, LCTL(KC_RIGHT), \
